...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::info!("🚀 SP BCE Reconciliation - Complete Pipeline Demo");
    tracing::info!("Demonstrating end-to-end integration:");
    tracing::info!("  1. BCE Record Processing with real ZK proofs");
    ...
    // Add sample BCE records to demonstrate complete flow
    tracing::info!("📋 Creating sample BCE records...");
    pipeline.add_sample_bce_records().await.map_err(|e| format!("Failed to add BCE records: {:?}", e))?;
    ...
    tracing::info!("🔄 Running BCE pipeline for 60 seconds to demonstrate complete flow...");
    ...
    tracing::info!("🎉 BCE Pipeline Demo Complete!");
